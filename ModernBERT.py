from transformers import ModernBertModel, AutoTokenizer, ModernBertConfig
import torch
...
model = ModernBertModel(configuration).to(device)
...
np.savez_compressed("modernbert_embedding.npz", 
...
# save bert embeddings
np.savez_compressed("modernbert_embedding_test.npz", 
